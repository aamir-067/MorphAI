...
const index = () => {
    return (
        <View className='bg-background min-h-screen px-[10px]'>
            <ScrollView>
                <Text style={{ fontFamily: "Outfit-Medium" }} className='text-text text-3xl my-7'>Background Replace</Text>

                <TouchableOpacity activeOpacity={0.5} className='bg-[#1D1B20] min-h-[300px] items-center rounded-[10px] justify-center'>
